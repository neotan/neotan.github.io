---
title: "Atlantic (Canada) Immigration Pilot Program (AIPP)- Designated Employers (incl. NS, NB, NL, PEI)"
date: 2020-08-18
draft: false
summary: " "
resources:
...
tags: ["immigration", "Canada", "Atlantic", "AIPP", "employers"]
categories: ["tools"]
---
...
<script type="module">
  ...
  var urls = [
      "./aipp-new-brunswick-employers.json",
      "./aipp-newfoundland-labrador-employers.json",
      "./aipp-nova-scotia-employers.json",
      "./aipp-prince-edward-island-employers.json",
  ]
