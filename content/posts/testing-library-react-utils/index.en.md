...
date: 2021-03-20
description: "Test your React application with testing-library"
resources:
- name: "featured-image"
  src: "featured-image.png"
  
tags: ["jest", "testing-library", "hooks", "unit-test", "UT", "javascript"]
categories: ["notes"]
---
...
```
### bypassing Suspense() and lazy() API when testing components
```js
jest.mock('react', () => {
...
```
### freezing system date time, so that won't be botherred by date time presentation diff when taking snapshots
```js
...
```
### styled-components with react-query
```js
